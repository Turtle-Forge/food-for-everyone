...
(1, 'Bubur Cangijo', 324, 10000, 'Breakfast'),
(2, 'Sate Ayam', 449, 25000, 'Dinner'),
(3, 'Nasi Kuning ', 185, 15000, 'Breakfast'),
(4, 'Ayam Suwir', 365, 15000, 'Lunch'),
(5, 'Nasi Bakar', 585, 10000, 'Dinner'),
(6, 'Cilok', 464, 8000, 'Lunch'),
(7, 'Nasi Uduk', 785, 12000, 'Breakfast'),
(8, 'Soto Ayam', 537, 15000, 'Dinner'),
(9, 'Pempek', 547, 15000, 'Lunch'),
...
(16, 'Jagung rebus', 1050, 25000, 'Sayuran');
